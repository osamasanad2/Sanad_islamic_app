...
class _ReadingScreenState extends ConsumerState<ReadingScreen> {
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          IconButton(
                            ...
                            onPressed: currentPageIndex < _sortedPages.length - 1
          ...
          child: Directionality(
            ...
            child: Column(
              children: [
                ...
                const SizedBox(height: 20),
                ...pageInfo.verses.map((verse) => _buildVerseWidget(verse, pageInfo)),
              ],
            ),
          ),
        ),
  ...
  Widget _buildVerseWidget(Verse verse, PageInfo pageInfo) {
    final surahForVerse = ref.read(quranRepositoryProvider).getSurahNumberForVerse(
      pageInfo.pageNumber,
          ...
          children: [
            ...
            StatefulBuilder(
              builder: (ctx, setLocalState) => Column(
                children: [
                  Text('$_fontSize', style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                  Slider(
                    value: _fontSize,
                    min: 16,
                    max: 40,
