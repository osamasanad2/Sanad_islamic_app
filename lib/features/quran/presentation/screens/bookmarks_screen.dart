  ...
  Future<void> _loadBookmarks() async {
    ...
    for (final entry in data) {
      ...
      final surah = surahIndices.firstWhere(
        (s) => s.id == surahId,
        orElse: () => SurahIndex(id: surahId, name: '', transliteration: '', type: '', totalVerses: 0),
      );
    ...
    if (_bookmarks.isEmpty) {
      return Center(
        child: Column(
          ...
          children: [
            Icon(Icons.bookmark_border, size: 80, color: AppColors.primary.withValues(alpha: 0.2)),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        IconButton(
                          ...
                          tooltip: 'حذف',
                          onPressed: () => _deleteBookmark(bm['surah'] as int, bm['ayah'] as int),
