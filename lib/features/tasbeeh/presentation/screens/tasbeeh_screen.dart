...
class _TasbeehScreenState extends State<TasbeehScreen>
  ...
  final List<Map<String, dynamic>> _dhikrList = [
    ...
    {
      'text': 'اللّهُمَّ صَلِّ عَلَى مُحَمَّد',
      'target': 100,
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'أنت اليوم أنجزت أكثر من أمس بـ ${_totalToday > _weeklyData[5] ? _totalToday - _weeklyData[5] : 0} تسبيحة! 💪',
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Text(
                            '$g',
                            style: TextStyle(
                              color: _goal == g ? Colors.black : Colors.white54,
                              fontSize: 12,
                              fontWeight: FontWeight.bold,
                            ),
                          ),
