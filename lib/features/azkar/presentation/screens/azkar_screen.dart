...
class _AzkarScreenState extends State<AzkarScreen> {
  ...
  int get _completedCount =>
      _currentAzkar.where((z) => (z['remaining'] as int) == 0).length;
  double get _progress =>
      _currentAzkar.isEmpty ? 0 : _completedCount / _currentAzkar.length;
              ...
              child: Row(
                ...
                children: [
                  Icon(
                    ...
                    color: _isPlayingAll ? Colors.white : _accent,
                    size: 18,
                  ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  _progress >= 1.0
                      ? 'ما شاء الله! أتممت أذكار ${_currentCat['name']} 🎉'
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(
                        isDone ? '✓' : '$remaining',
                        style: TextStyle(
                          color: isDone ? Colors.white : _accent,
                          fontWeight: FontWeight.bold,
                          fontSize: 14,
                        ),
                      ),
                      ...
                      child: ClipRRect(
                        ...
                        child: LinearProgressIndicator(
                          ...
                          valueColor: AlwaysStoppedAnimation<Color>(
                            isDone ? _accent : _accent.withValues(alpha: 0.5),
                          ),
                        ),
                      ),
                    ),
